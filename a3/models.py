...
class CrossAttentionLayer(nn.Module):
    ...
    def forward(self, seq1, seq1_key_padding_mask, seq2,
        ...
        seq1 = self.norm_122(ca12 + self.ffn_12(ca12.view(-1, ca12.shape[2])).view(ca12.shape))
        ...
        seq2 = self.norm_212(ca21 + self.ffn_21(ca21.view(-1, ca21.shape[2])).view(ca21.shape))
